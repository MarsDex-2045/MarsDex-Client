    ...
    document.querySelector('body').innerHTML += `
        ...
        <section id="settings-page" class="hidden">
            ...
            <div>
                ...
                <input type="radio" name="sound" id="soundOn" value="on" checked/>
                <label for="soundOn">on</label>
                <input\ttype="radio" name="sound" id="soundOff" value="off"/>
            ...
            <a href="#"><span class="fas fa-user-secret"></span><div>privacy policy</div></a>
